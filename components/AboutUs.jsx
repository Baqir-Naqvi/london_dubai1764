        ...
        <div className='md:px-[10%]  items-center '>
          {city === "Dubai" ? (
            <p className='md:text-[22px] md:mt-[70px] text-[14px] text-white opacity-80 font-[100] md:text-center md:px-0 px-3'>
              ...
              developers, investors, professionals and enthusiasts could
              network, collaborate and socialise around all things Blockchain,
            ...
            <p className='md:text-[22px] md:mt-[70px] text-[14px] text-white opacity-80 font-[100] md:text-center md:px-0 px-3'>
              ...
              founders, developers, investors, professionals and enthusiasts
              could network, collaborate and socialise around all things
              Blockchain, DeFi, Crypto, NFTs, Web3, AI & Tech.
            </p>
          )}
          ...
          >
            ...
            <p className='md:text-[22px] text-[14px] text-white opacity-80 md:pl-[40px] md:mt-0 mt-10'>
              ...
              movement in the 19th Century. Since 1764, it has always been a
              venue where innovators, contrarians, pioneers and disruptors
              assemble and has now firmly moved into the 21st Century with a new
              focus, affiliating those involved in emerging technologies.
            </p>
          </div>
